...
const RegisteredUsers = () => {
  ...
  const getActivityImage = (activityName) => {
    const activityImages = {
      ...
      "Ping-pong":
        "https://images.unsplash.com/photo-1534158914592-062992fbe900",
      "Tir à l'arc":
        "https://images.unsplash.com/photo-1584280795027-61e02c757b0e",
      "Mini-golf":
      ...
      "Chasse au trésor":
        "https://images.unsplash.com/photo-1586107874284-ee5852c10fe1",
      "Atelier créatif":
      ...
      "Aires de jeux":
        "https://images.unsplash.com/photo-1542868727-869b1353c785",
    ...
    return (
      ...
      "https://images.unsplash.com/photo-1533134486753-c833f0ed4866?ixlib=rb-4.0.3&auto=format&fit=crop"
    );
  };
    ...
    const fetchCreneaux = async () => {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(
            `Échec de la récupération des créneaux: ${response.status} ${errorData}`
          );
        }
          ...
          <div className="relative h-96">
            ...
            <div className="absolute bottom-0 left-0 p-6 text-white">
              <h1 className="text-4xl font-bold mb-2">
                {activityDetails.nom_animation}
              </h1>
              <p className="text-lg mb-3">
                {activityDetails.descriptif_animation}
              </p>
              <div className="flex items-center space-x-6">
                ...
                <span className="flex items-center">
                  ...
                  {activityDetails.places_prises} /{" "}
                  {activityDetails.places_totales} places
                </span>
              </div>
            </div>
          </div>
        ...
        {users.length > 0 ? (
                    ...
                    <div className="flex items-center">
                      <label className="inline-flex items-center">
                        <input
                          ...
                          checked={
                            absentUsers[user.id_compte] || user.estAbs || false
                          }
          ...
          <div className="text-center py-12 px-6 bg-gray-50">
            ...
            <p className="mt-2 text-gray-500">
              Les inscriptions apparaîtront ici une fois que des personnes se
              seront inscrites.
            </p>
          </div>
        )}
